...
# Validate the Pi Docker Sandbox Kit spec (pi/spec.yaml) against the current
# Sandbox Kit schema. Runs identically locally and in CI.
#
...
echo "Validating ${repo_root} against the current Sandbox Kit schema..."
exec sbx kit validate "${repo_root}/"
